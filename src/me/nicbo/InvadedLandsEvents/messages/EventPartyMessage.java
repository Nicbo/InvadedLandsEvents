...
public enum EventPartyMessage {
    ...
    PARTY_UNINVITE(ChatColor.GOLD + "{leader}" + ChatColor.YELLOW + " has uninvited you from their party."),
    PARTY_UNINVITE_PLAYER(ChatColor.GOLD + "{player}" + ChatColor.YELLOW + " has been uninvited from the party."),
